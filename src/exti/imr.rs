...
pub type IM0_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM2_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM3_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM4_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM5_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM6_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM7_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM8_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM9_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM10_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM11_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM12_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM13_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM14_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM15_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM16_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM17_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM18_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM19_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IM29_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn im0(&mut self) -> IM0_W<IMR_SPEC, 0> {
        IM0_W::new(self)
    }
    #[doc = "Bit 1 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im1(&mut self) -> IM1_W<IMR_SPEC, 1> {
        IM1_W::new(self)
    }
    #[doc = "Bit 2 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im2(&mut self) -> IM2_W<IMR_SPEC, 2> {
        IM2_W::new(self)
    }
    #[doc = "Bit 3 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im3(&mut self) -> IM3_W<IMR_SPEC, 3> {
        IM3_W::new(self)
    }
    #[doc = "Bit 4 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im4(&mut self) -> IM4_W<IMR_SPEC, 4> {
        IM4_W::new(self)
    }
    #[doc = "Bit 5 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im5(&mut self) -> IM5_W<IMR_SPEC, 5> {
        IM5_W::new(self)
    }
    #[doc = "Bit 6 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im6(&mut self) -> IM6_W<IMR_SPEC, 6> {
        IM6_W::new(self)
    }
    #[doc = "Bit 7 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im7(&mut self) -> IM7_W<IMR_SPEC, 7> {
        IM7_W::new(self)
    }
    #[doc = "Bit 8 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im8(&mut self) -> IM8_W<IMR_SPEC, 8> {
        IM8_W::new(self)
    }
    #[doc = "Bit 9 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im9(&mut self) -> IM9_W<IMR_SPEC, 9> {
        IM9_W::new(self)
    }
    #[doc = "Bit 10 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im10(&mut self) -> IM10_W<IMR_SPEC, 10> {
        IM10_W::new(self)
    }
    #[doc = "Bit 11 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im11(&mut self) -> IM11_W<IMR_SPEC, 11> {
        IM11_W::new(self)
    }
    #[doc = "Bit 12 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im12(&mut self) -> IM12_W<IMR_SPEC, 12> {
        IM12_W::new(self)
    }
    #[doc = "Bit 13 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im13(&mut self) -> IM13_W<IMR_SPEC, 13> {
        IM13_W::new(self)
    }
    #[doc = "Bit 14 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im14(&mut self) -> IM14_W<IMR_SPEC, 14> {
        IM14_W::new(self)
    }
    #[doc = "Bit 15 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im15(&mut self) -> IM15_W<IMR_SPEC, 15> {
        IM15_W::new(self)
    }
    #[doc = "Bit 16 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im16(&mut self) -> IM16_W<IMR_SPEC, 16> {
        IM16_W::new(self)
    }
    #[doc = "Bit 17 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im17(&mut self) -> IM17_W<IMR_SPEC, 17> {
        IM17_W::new(self)
    }
    #[doc = "Bit 18 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im18(&mut self) -> IM18_W<IMR_SPEC, 18> {
        IM18_W::new(self)
    }
    #[doc = "Bit 19 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im19(&mut self) -> IM19_W<IMR_SPEC, 19> {
        IM19_W::new(self)
    }
    #[doc = "Bit 29 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im29(&mut self) -> IM29_W<IMR_SPEC, 29> {
        IM29_W::new(self)
    }
