...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn exti5(&mut self) -> EXTI5_W<EXTICR2_SPEC, 8> {
        EXTI5_W::new(self)
    }
    #[doc = "Bit 16 - GPIO port selection"]
    #[inline(always)]
    #[must_use]
    pub fn exti6(&mut self) -> EXTI6_W<EXTICR2_SPEC, 16> {
        EXTI6_W::new(self)
    }
    #[doc = "Bit 24 - GPIO port selection"]
    #[inline(always)]
    #[must_use]
    pub fn exti7(&mut self) -> EXTI7_W<EXTICR2_SPEC, 24> {
        EXTI7_W::new(self)
    }
