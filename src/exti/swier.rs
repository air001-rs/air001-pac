...
pub type SWI8_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SWI9_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SWI10_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SWI11_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SWI12_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SWI13_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SWI14_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SWI15_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SWI16_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SWI17_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SWI18_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn swi0(&mut self) -> SWI0_W<SWIER_SPEC, 0> {
        SWI0_W::new(self)
    }
    #[doc = "Bit 1 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn swi1(&mut self) -> SWI1_W<SWIER_SPEC, 1> {
        SWI1_W::new(self)
    }
    #[doc = "Bit 2 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn swi2(&mut self) -> SWI2_W<SWIER_SPEC, 2> {
        SWI2_W::new(self)
    }
    #[doc = "Bit 3 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn swi3(&mut self) -> SWI3_W<SWIER_SPEC, 3> {
        SWI3_W::new(self)
    }
    #[doc = "Bit 4 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn swi4(&mut self) -> SWI4_W<SWIER_SPEC, 4> {
        SWI4_W::new(self)
    }
    #[doc = "Bit 5 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn swi5(&mut self) -> SWI5_W<SWIER_SPEC, 5> {
        SWI5_W::new(self)
    }
    #[doc = "Bit 6 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn swi6(&mut self) -> SWI6_W<SWIER_SPEC, 6> {
        SWI6_W::new(self)
    }
    #[doc = "Bit 7 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn swi7(&mut self) -> SWI7_W<SWIER_SPEC, 7> {
        SWI7_W::new(self)
    }
    #[doc = "Bit 8 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn swi8(&mut self) -> SWI8_W<SWIER_SPEC, 8> {
        SWI8_W::new(self)
    }
    #[doc = "Bit 9 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn swi9(&mut self) -> SWI9_W<SWIER_SPEC, 9> {
        SWI9_W::new(self)
    }
    #[doc = "Bit 10 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn swi10(&mut self) -> SWI10_W<SWIER_SPEC, 10> {
        SWI10_W::new(self)
    }
    #[doc = "Bit 11 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn swi11(&mut self) -> SWI11_W<SWIER_SPEC, 11> {
        SWI11_W::new(self)
    }
    #[doc = "Bit 12 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn swi12(&mut self) -> SWI12_W<SWIER_SPEC, 12> {
        SWI12_W::new(self)
    }
    #[doc = "Bit 13 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn swi13(&mut self) -> SWI13_W<SWIER_SPEC, 13> {
        SWI13_W::new(self)
    }
    #[doc = "Bit 14 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn swi14(&mut self) -> SWI14_W<SWIER_SPEC, 14> {
        SWI14_W::new(self)
    }
    #[doc = "Bit 15 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn swi15(&mut self) -> SWI15_W<SWIER_SPEC, 15> {
        SWI15_W::new(self)
    }
    #[doc = "Bit 16 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn swi16(&mut self) -> SWI16_W<SWIER_SPEC, 16> {
        SWI16_W::new(self)
    }
    #[doc = "Bit 17 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn swi17(&mut self) -> SWI17_W<SWIER_SPEC, 17> {
        SWI17_W::new(self)
    }
    #[doc = "Bit 18 - Rising trigger event configuration bit of Configurable Event input"]
    #[inline(always)]
    #[must_use]
    pub fn swi18(&mut self) -> SWI18_W<SWIER_SPEC, 18> {
        SWI18_W::new(self)
    }
