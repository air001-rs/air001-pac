...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ot9(&mut self) -> OT9_W<OTYPER_SPEC, 9> {
        OT9_W::new(self)
    }
    #[doc = "Bit 10 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn ot10(&mut self) -> OT10_W<OTYPER_SPEC, 10> {
        OT10_W::new(self)
    }
    #[doc = "Bit 11 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn ot11(&mut self) -> OT11_W<OTYPER_SPEC, 11> {
        OT11_W::new(self)
    }
    #[doc = "Bit 12 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn ot12(&mut self) -> OT12_W<OTYPER_SPEC, 12> {
        OT12_W::new(self)
    }
    #[doc = "Bit 13 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn ot13(&mut self) -> OT13_W<OTYPER_SPEC, 13> {
        OT13_W::new(self)
    }
    #[doc = "Bit 14 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn ot14(&mut self) -> OT14_W<OTYPER_SPEC, 14> {
        OT14_W::new(self)
    }
    #[doc = "Bit 15 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn ot15(&mut self) -> OT15_W<OTYPER_SPEC, 15> {
        OT15_W::new(self)
    }
