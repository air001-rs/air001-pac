...
pub type TIM14RST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type COMP1RST_R = crate::BitReader;
#[doc = "Field `COMP1RST` writer - COMP1 reset"]
pub type COMP1RST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `COMP2RST` reader - COMP2 reset"]
pub type COMP2RST_R = crate::BitReader;
#[doc = "Field `COMP2RST` writer - COMP2 reset"]
pub type COMP2RST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `LEDRST` reader - LED reset"]
pub type LEDRST_R = crate::BitReader;
#[doc = "Field `LEDRST` writer - LED reset"]
pub type LEDRST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn syscfgrst(&mut self) -> SYSCFGRST_W<APBRSTR2_SPEC, 0> {
        SYSCFGRST_W::new(self)
    }
    #[doc = "Bit 11 - TIM1 timer reset"]
    #[inline(always)]
    #[must_use]
    pub fn tim1rst(&mut self) -> TIM1RST_W<APBRSTR2_SPEC, 11> {
        TIM1RST_W::new(self)
    }
    #[doc = "Bit 12 - SPI1 reset"]
    #[inline(always)]
    #[must_use]
    pub fn spi1rst(&mut self) -> SPI1RST_W<APBRSTR2_SPEC, 12> {
        SPI1RST_W::new(self)
    }
    #[doc = "Bit 14 - USART1 reset"]
    #[inline(always)]
    #[must_use]
    pub fn usart1rst(&mut self) -> USART1RST_W<APBRSTR2_SPEC, 14> {
        USART1RST_W::new(self)
    }
    #[doc = "Bit 15 - TIM14 timer reset"]
    #[inline(always)]
    #[must_use]
    pub fn tim14rst(&mut self) -> TIM14RST_W<APBRSTR2_SPEC, 15> {
        TIM14RST_W::new(self)
    }
    #[doc = "Bit 17 - TIM16 timer reset"]
    #[inline(always)]
    #[must_use]
    pub fn tim16rst(&mut self) -> TIM16RST_W<APBRSTR2_SPEC, 17> {
        TIM16RST_W::new(self)
    }
    #[doc = "Bit 18 - TIM17 timer reset"]
    #[inline(always)]
    #[must_use]
    pub fn tim17rst(&mut self) -> TIM17RST_W<APBRSTR2_SPEC, 18> {
        TIM17RST_W::new(self)
    }
    #[doc = "Bit 20 - ADC reset"]
    #[inline(always)]
    #[must_use]
    pub fn adcrst(&mut self) -> ADCRST_W<APBRSTR2_SPEC, 20> {
        ADCRST_W::new(self)
    }
    #[doc = "Bit 21 - COMP1 reset"]
    #[inline(always)]
    #[must_use]
    pub fn comp1rst(&mut self) -> COMP1RST_W<APBRSTR2_SPEC, 21> {
        COMP1RST_W::new(self)
    }
    #[doc = "Bit 22 - COMP2 reset"]
    #[inline(always)]
    #[must_use]
    pub fn comp2rst(&mut self) -> COMP2RST_W<APBRSTR2_SPEC, 22> {
        COMP2RST_W::new(self)
    }
    #[doc = "Bit 23 - LED reset"]
    #[inline(always)]
    #[must_use]
    pub fn ledrst(&mut self) -> LEDRST_W<APBRSTR2_SPEC, 23> {
        LEDRST_W::new(self)
    }
