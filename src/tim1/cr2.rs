...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ois2(&mut self) -> OIS2_W<CR2_SPEC, 10> {
        OIS2_W::new(self)
    }
    #[doc = "Bit 11 - Output Idle state 2"]
    #[inline(always)]
    #[must_use]
    pub fn ois2n(&mut self) -> OIS2N_W<CR2_SPEC, 11> {
        OIS2N_W::new(self)
    }
    #[doc = "Bit 12 - Output Idle state 3"]
    #[inline(always)]
    #[must_use]
    pub fn ois3(&mut self) -> OIS3_W<CR2_SPEC, 12> {
        OIS3_W::new(self)
    }
    #[doc = "Bit 13 - Output Idle state 3"]
    #[inline(always)]
    #[must_use]
    pub fn ois3n(&mut self) -> OIS3N_W<CR2_SPEC, 13> {
        OIS3N_W::new(self)
    }
    #[doc = "Bit 14 - Output Idle state 4"]
    #[inline(always)]
    #[must_use]
    pub fn ois4(&mut self) -> OIS4_W<CR2_SPEC, 14> {
        OIS4_W::new(self)
    }
