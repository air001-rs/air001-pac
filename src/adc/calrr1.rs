...
pub type R = crate::R<CALRR1_SPEC>;
#[doc = "Field `CALC4OUT` reader - C4 result"]
pub type CALC4OUT_R = crate::FieldReader;
#[doc = "Field `CALC5OUT` reader - C5 result"]
pub type CALC5OUT_R = crate::FieldReader;
#[doc = "Field `CALBOUT` reader - offset result"]
pub type CALBOUT_R = crate::FieldReader;
impl R {
...
#[doc = "ADC calibration result register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`calrr1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
