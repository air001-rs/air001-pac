...
pub type R = crate::R<CALRR2_SPEC>;
#[doc = "Field `CALC0OUT` reader - C0 result"]
pub type CALC0OUT_R = crate::FieldReader;
#[doc = "Field `CALC1OUT` reader - C1 result"]
pub type CALC1OUT_R = crate::FieldReader;
#[doc = "Field `CALC2OUT` reader - C2 result"]
pub type CALC2OUT_R = crate::FieldReader;
#[doc = "Field `CALC3OUT` reader - C3 result"]
pub type CALC3OUT_R = crate::FieldReader;
impl R {
...
#[doc = "ADC calibration result register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`calrr2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
