...
pub type SCANDIR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `RESSEL` reader - ADC data resolution"]
pub type RESSEL_R = crate::FieldReader;
#[doc = "Field `RESSEL` writer - ADC data resolution"]
pub type RESSEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type AWDCH_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ressel(&mut self) -> RESSEL_W<CFGR1_SPEC, 3> {
        RESSEL_W::new(self)
    }
    #[doc = "Bit 5 - ADC data alignement"]
    #[inline(always)]
